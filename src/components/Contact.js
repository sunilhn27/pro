...
function Contact() {
    ...
    return (
        <section className='mt-96 md:mt-16 mx-[1rem]'>
            <div className='flex flex-col-reverse md:flex-row justify-center items-center space-x-16'>
                <div>
                    <form className='flex flex-col justify-center items-center w-[37rem] md:w-[36rem] h-[40rem]'>
                        <input
                            className='w-[18rem] md:w-full h-[3rem] mb-4 px-2 placeholder:text-gray-500 rounded-lg border-2 border-gray-400'
                            placeholder='Name'
                            value={name}
                        ...
                        />
                        <textarea
                            className='w-[18rem] md:w-full h-[11rem] mb-4 px-2 placeholder:text-gray-500 rounded-lg border-2 border-gray-400 resize-none'
                            placeholder='Message'
                            value={message}
                        ...
                        <div className='mt-12' onClick={sendEmail}>
                            <button
                                ...
                                className={`w-[18rem] md:w-full h-[3rem] bg-[#7E74F1] font-bold rounded-lg ${
                                    disableSendBtn ? '' : 'opacity-50 cursor-not-allowed'
                                }`}
                            >
                                Send Message
                            </button>
                ...
                <div>
                    <div className='md:mb-16 w-[24rem] h-[16rem]'>
                        <div className='flex flex-col'>
